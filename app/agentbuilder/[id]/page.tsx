...
// export default function UpdateForm({ agentId }: AgentFormProps) {
...
export default function UpdateAgentPage() {
 ...
 useEffect(() => {
  ...
  useEffect(() => {
    ...
    const fetchAgentDetails = async () => {
      try {
        const res = await fetch(`http://triasoft.io:8000/api/agents/${id}`, {
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Sidebar - Steps */}
        <aside className="bg-white p-6 border-r border-gray-200 overflow-y-auto w-64">
          <h2 className="text-lg font-semibold mb-4 text-violet-700">Steps</h2>
          <ul className="space-y-3">
        ...
        <main className="flex-1 overflow-y-auto p-6 bg-gray-50">
          <form onSubmit={handleSubmit} className="max-w-4xl mx-auto space-y-6">
            <h2 className="text-2xl font-bold text-gray-800">Update Agent</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* API Name */}
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-1">API Name</label>
                <input
                  name="api_name"
                  value={formData.api_name}
                  onChange={handleChange}
              ...
              {/* User Type */}
              <div className="md:col-span-2">
                <label className="block text-sm font-bold text-gray-700 mb-1">Agent User</label>
                <select
                  name="user_type"
                  value={formData.user_type}
                  onChange={handleChange}
        ...
        <aside className="hidden lg:block bg-gray-100 p-6 border-l border-gray-200 overflow-y-auto w-80">
          <h3 className="text-lg font-bold mb-4 text-gray-700">
            Best Practices for Agent Settings
          </h3>
          <ul className="space-y-4 text-sm text-gray-600">
            <li>
              Agent settings determine how an AI agent behaves and presents itself in
              conversations. Use these best practices to help you write concise and
            ...
            <li>
              <strong className="block text-gray-800">Organization:</strong>
              Tell the agent about the organization it represents. Describe what your
              organization does, who its customers are, and what makes it unique.
            </li>
          </ul>
        </aside>
      </div>
